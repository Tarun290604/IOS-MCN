...
int xnap_find_id(xnap_id_manager *m, int id_source, int id_target)
{
  int i;
  for (i = 0; i < XNAP_MAX_IDS; i++)
    if (m->ids[i].cu_ue_id != -1 && m->ids[i].id_source == id_source && m->ids[i].id_target == id_target)
      return i;
  return -1;
}
...
int xnap_find_id_from_id_source(xnap_id_manager *m, int id_source)
{
  int i;
  for (i = 0; i < XNAP_MAX_IDS; i++)
    if (m->ids[i].cu_ue_id != -1 && m->ids[i].id_source == id_source)
      return i;
  return -1;
}
...
int xnap_find_id_from_id_target(xnap_id_manager *m, int id_target)
{
  int i;
  for (i = 0; i < XNAP_MAX_IDS; i++)
    if (m->ids[i].cu_ue_id != -1 && m->ids[i].id_target == id_target)
      return i;
  return -1;
}
